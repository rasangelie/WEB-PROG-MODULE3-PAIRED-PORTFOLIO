...
fetch("https://ghibliapi.herokuapp.com/films") 
    .then (function (response) {
        ...
        response.json().then(function (data) {
            const yearRelease = data[15].release_date;
            const time = data[15].running_time;
            const title = data[15].title
            const description = data[15].description;
            const director = data[15].director;
            const producer = data[15].producer;
