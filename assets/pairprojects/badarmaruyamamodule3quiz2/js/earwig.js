...
fetch("https://ghibliapi.herokuapp.com/films") 
    .then (function (response) {
        ...
        response.json().then(function (data) {
            const yearRelease = data[21].release_date;
            const time = data[21].running_time;
            const title = data[21].title
            const description = data[21].description;
            const director = data[21].director;
            const producer = data[21].producer;
